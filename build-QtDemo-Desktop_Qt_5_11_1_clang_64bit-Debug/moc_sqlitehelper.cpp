...
#include "../QtDemo/SqliteDB/sqlitehelper.h"
...
QT_MOC_LITERAL(1, 13, 12), // "loadSqliteDB"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13) // "closeSqliteDB"

    },
    "SqliteHelper\0loadSqliteDB\0\0closeSqliteDB"
};
...
void SqliteHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->loadSqliteDB();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->closeSqliteDB(); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject SqliteHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SqliteHelper.data,
      qt_meta_data_SqliteHelper,  qt_static_metacall, nullptr, nullptr}
};
